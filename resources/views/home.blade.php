            ...
            <div class="widget-content widget-content-area">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <div class="alert alert-arrow-left alert-icon-left alert-light-primary mb-4" role="alert" style="font-size: 25px">
                            ...
                            <strong>Caja de Jubilaciones y Pensiones del Personal Municipal!</strong> En construcción Factura Electrónica.
                        </div>
                    </div>
                </div>
