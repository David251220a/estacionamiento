...
<div class="col-lg-12 layout-spacing">
    <div class="statbox widget box box-shadow">
        <div class="widget-content widget-content-area">
            ...
            <h4 class="font-bold mb-3">REGISTRO VEHICULO</h4>
                    ...
                    <div class="card component-card_4">
                        <div class="card-body">
                            ...
                            <div class="user-info">
                                ...
                                <p class="card-user_occupation">Hora Ingreso</p>
                                <div class="card-star_rating">
                                    <span class="badge badge-primary">{{$registro_diario->hora_ingreso}}</span>
                                </div>
                                <p class="card-text">
                                    Plan eligido: {{$registro_diario->plan->descripcion}}
                                </p>
                                <a href="{{route('registro.imprimir', $registro_diario)}}" class="btn btn-info" target="__blank">Imprimir</a>
                            </div>
                        </div>
                    </div>
